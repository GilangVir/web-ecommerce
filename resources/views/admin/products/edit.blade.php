                ...
                <div class="p-6 text-gray-900">
                    <form method="POST" action="{{ route('admin.products.update', $product) }}" enctype="multipart/form-data">
                        ...
                        <div class="mt-4">
                            ...
                            <img src="{{ Storage::url($product->cover) }}" class="h-[100px] w-auto">
                        ...
                        <div class="mt-4">
                            ...
                            <x-text-input id="name" value="{{ $product->name }}" class="block mt-1 w-full" type="text" name="name"/>
                            <x-input-error :messages="$errors->get('name')" class="mt-2" />
                        </div>

                        <div class="mt-4">
                            <x-input-label for="price" :value="__('Price')" />
                            <x-text-input id="price" value="{{ $product->price }}" class="block mt-1 w-full" type="number" name="price"/>
                            <x-input-error :messages="$errors->get('price')" class="mt-2" />
                        </div>

                        <div class="mt-4">
                            <x-input-label for="category" :value="__('Category')" />
                            <select name="category_id" id="category" class="w-full py-4 pl-5 border">
